...
if (!$impostazioni[0]['showcredit']) {
    ?>
        <span style="font-size: 80%; padding-right: 10px;"><a class="rate" href="http://codecanyon.net/downloads"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></a><?=$this->lang->line('sviluppatoda');?> <a href="http://luigiverzi.it" style="color: lightgrey;">amrit@dsmnru</a></span>
			<?php 
} ?>
